...
class ObjectDetectionApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Dental disease using XRAY Images")
        self.root.geometry("800x800")  # Set window size

        style = ThemedStyle(root)
        style.set_theme("equilux")  # Set the theme for the whole app

        title_label = tk.Label(root, text="Dental disease using XRAY Images ", font=("Helvetica", 20))
        ...
        # Load YOLO model
        self.model = YOLO("d:/navya/Downloads/Code_Files_Batch_17 (1)/dental_/runs/detect/train9/weights/best.pt")
